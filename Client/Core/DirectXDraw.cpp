...
DirectXDraw* DirectXDraw::m_pInstance;
...
float DirectXDraw::_DrawText(ImFont* pFont, const std::string& text, const ImVec2& pos, float size, uint32_t color, bool center)
{
	ImGuiWindow* window = ImGui::GetCurrentWindow();
...
void DirectXDraw::DrawLine(const ImVec2& from, const ImVec2& to, uint32_t color, float thickness)
{
	ImGuiWindow* window = ImGui::GetCurrentWindow();
...
void DirectXDraw::DrawCircle(const ImVec2& position, float radius, uint32_t color, float thickness)
{
	ImGuiWindow* window = ImGui::GetCurrentWindow();
...
void DirectXDraw::DrawCircleFilled(const ImVec2& position, float radius, uint32_t color)
{
	ImGuiWindow* window = ImGui::GetCurrentWindow();
...
DirectXDraw* DirectXDraw::GetInstance()
{
	if (!m_pInstance)
		m_pInstance = new DirectXDraw();
